...
<SiteLayout title="Exhibition and Sponsorship Opportunities" accent="linen">

<Image
  src="/images/2025/partnership-banner-2025.png"
...
<div>
  ...
  community of peers. With nearly 1,200 attendees in 2024, oSTEM’s Annual
...
We invite you to join us in Baltimore, MD. As a partner you will be a critical
member of our community.

<div className="flex flex-col items-center text-xl my-4">
  <div className="pb-4">
    <CTAButton
      onClick="https://ostemfilestorage.blob.core.windows.net/publicfiles/oSTEM2025Prospectus.pdf"
  ...
  <div className="pt-2">
    <CTAButton
      onClick="https://form.jotform.com/250125741779158"
