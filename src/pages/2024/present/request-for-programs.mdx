...
<div>
<Tab.Group>
<Tab.List className='mt-4 pt-1 sticky top-[87px] sm:top-[64px] flex space-x-1 p-1 bg-primary border-b border-text-color'>
  {/* Learn more about:&nbsp; */}
  {
    ['Collegiate', 'Industry', 'Technical Spotlight'].map(e => (<Tab className={({selected}) => (`${selected ? `text-nav-blue bg-blue-300/25` : `hover:bg-blue-300/15`} transition rounded px-1 text-lg`)} key={e}>{e}</Tab>))
  }
</Tab.List>
