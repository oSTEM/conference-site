...
<div>
<Tab.Group>
<Tab.List className='mt-4 pt-1 sticky top-[87px] sm:top-[64px] flex space-x-1 p-1 bg-primary border-b'>
  {/* Learn more about:&nbsp; */}
  {
    ['Collegiate', 'Industry', 'Technical Spotlight'].map(e => (<Tab className={({selected}) => (`${selected ? `text-nav-blue bg-blue-200/25` : `hover:bg-blue-200/15`} transition rounded px-1 text-lg`)} key={e}>{e}</Tab>))
  }
</Tab.List>
<Tab.Panels className='border-b border-l border-r px-4 border-x-gray-500/50'>
<Tab.Panel>
<div className="text-nav-blue font-bold">
