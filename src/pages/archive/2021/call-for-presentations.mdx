...
<div className="border-b-4 border-mulberry border-solid pb-4 mb-4 text-center">
    <p className="text-5xl font-display font-medium">Call for Poster and Symposium Presentations</p>
</div>
...
<div className="text-center text-2xl m-4">
    <CTAButton onClick={"https://www.jotform.com/build/211807150158147"}>
...
- October 1:  Application Closes (Posters are accepted on a rolling basis)
