...
<div className="my-2 flex flex-col items-center sm:flex-row justify-center">
  ...
  <div className="my-1 sm:mx-2 mb-0.5">
...
**We highly recommend staying at the Anaheim Marriott Hotel to ensure you have
the best conference experience possible. Benefits of staying at the conference
hotel include:**
